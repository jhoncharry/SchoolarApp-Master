...
export class Config {
    ...
    'jhipster.mail.from' = 'schoolarapp@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'schoolarapp API';
    'jhipster.swagger.description' = 'schoolarapp API documentation';
    ...
    'eureka.instance.appname' = 'schoolarapp';
    'eureka.instance.instanceId' = 'schoolarapp:${random.value}';
